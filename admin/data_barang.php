                        ...
                        <?php foreach ($barang as $data) : ?>
                            <tr>
                                ...
                                <td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="edit_barang.php" method="post">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="nama" class="form-label">Nama</label>
                                                            <input type="text" name="nama" value="<?= $data['nama_barang'] ?>" class="form-control" disabled>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="option" class="form-label">Pilih Kategori</label>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="harga_pokok" class="form-label">Harga Pokok</label>
                                                                <input type="number" name="harga_pokok" value="<?= $data['harga_pokok'] ?>" class="form-control" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="harga_jual" class="form-label">Harga Jual</label>
                                    ...
                                    <button class="btn">
                                        <a href="hapus_barang.php?id=<?php echo $data['id_barang']?>" onclick="return confirm('anda yakin akan menghapus data?')"><i class="fas fa-trash"></i>Hapus</span></a>
                                    </button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
