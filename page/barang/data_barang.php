...
<form class="row float-sm-end " action="?page=databarang" method="post">
...
<table class="table table-sm">
    ...
    if(isset($_POST['cari'])) {
        $cari=$_POST['cari'];
        $tb_barang= mysqli_query($conn,"SELECT * FROM tb_barang,tb_kategori WHERE tb_barang.id_kategori = tb_kategori.id_kategori AND nama_barang like '%$cari%'") or die($conn->error);
    } else {
